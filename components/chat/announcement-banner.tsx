  ...
  return (
    <div className="relative z-40 flex items-center justify-center gap-2.5 border-primary/30 border-b bg-primary/10 px-10 py-2.5 text-center">
      ...
      <p className="text-[13px] text-foreground sm:text-sm">
        <span className="font-semibold text-primary">NEW:</span> Cinematic tier
        videos now run on Veo 3.1 - same credits, even better quality.{" "}
        <Link
...
// ============================================================
// END OF FILE - components/chat/announcement-banner.tsx (v1.1 - copy tweak)
