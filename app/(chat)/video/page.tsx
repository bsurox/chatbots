...
import { ASPECT_RATIOS, CINEMATIC_PRICING, type CinematicSeconds, download, fmt, JOB_KEY, TIERS, type AspectRatio, type Tier } from "./video-config";
  ...
  return (
    <>
      ...
      <div className="vg-wrap">
        ...
        <label className="vg-label" style={{ color: formatError ? "#f87171" : undefined }}>Format</label>
        <div className="vg-tiers">
          {ASPECT_RATIOS.map((r) => (
            <button
              key={r.id}
              ...
              style={{ borderColor: formatError ? "#ef4444" : undefined }}
              onClick={() => {
                setAspectRatio(r.id);
        ...
        {formatError && (
          <p style={{ marginTop: -14, marginBottom: 18, fontSize: 13, color: "#f87171" }}>
            Please select a format before generating.
          </p>
        )}
