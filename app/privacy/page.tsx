...
const SECTIONS: Array<{ t: string; b: string }> = [
  {
    t: "1. Who We Are",
    b: `AskEvo LLC ("AskEvo", "we", "us") is a company based in Idaho, USA. We operate askevo.ai, including the Evo AI assistant, image generation, voice generation, speech-to-text, video generation, and related products such as the AdReel early-access waitlist. This policy explains what information we collect, how we use it, and the choices you have.`,
  },
  {
...
Content you provide: chat messages and prompts, files and audio you upload, and the content our tools generate for you.
...
Support and waitlist submissions: your name, email address, and message when you contact support or join a waitlist.
...
Usage data: basic technical information such as IP address, browser type, and timestamps, collected by our hosting infrastructure for security and reliability.`,
  },
  {
    ...
    b: `We use your information to: provide and operate the services; generate the AI outputs you request; process purchases and maintain your credit balance; respond to support requests; send service communications (such as early-access notifications you signed up for); protect against fraud, abuse, and security issues; and improve the services.`,
  },
  {
    t: "4. AI Processing and Service Providers",
    b: `To fulfill your requests, your content is processed by third-party AI providers acting on our behalf: Anthropic (chat), Stability AI (image generation), ElevenLabs (voice generation), OpenAI (speech-to-text), and fal.ai (video generation).
...
// -----------------------------------------------------------
// END OF FILE (privacy page) - if you can see these lines
